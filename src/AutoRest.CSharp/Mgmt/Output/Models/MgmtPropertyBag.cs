    ...
    internal class MgmtPropertyBag : PropertyBag
    {
        ...
        protected override TypeProvider EnsurePackModel()
        {
            ...
            foreach (var parameter in _paramsToKeep)
            {
                ...
                var property = new InputModelProperty(parameter.Name, parameter.Name, description, inputParameter!.Type, parameter.DefaultValue == null ? null : inputParameter.DefaultValue, parameter.DefaultValue == null, false, false, inputParameter.IsNullable);
