...
namespace _Specs_.Azure.Core.Lro.Standard
{
    ...
    public partial class StandardClient
    {
        ...
        /// <include file="Docs/StandardClient.xml" path="doc/members/member[@name='DeleteAsync(WaitUntil,string,CancellationToken)']/*" />
        public virtual async Task<Operation<OperationStatus>> DeleteAsync(WaitUntil waitUntil, string name, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));

            RequestContext context = FromCancellationToken(cancellationToken);
            Operation<BinaryData> response = await DeleteAsync(waitUntil, name, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(response, OperationStatus.FromResponse, ClientDiagnostics, "StandardClient.Delete");
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Deletes a User. </remarks>
        /// <include file="Docs/StandardClient.xml" path="doc/members/member[@name='Delete(WaitUntil,string,CancellationToken)']/*" />
        public virtual Operation<OperationStatus> Delete(WaitUntil waitUntil, string name, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));

            RequestContext context = FromCancellationToken(cancellationToken);
            Operation<BinaryData> response = Delete(waitUntil, name, context);
            return ProtocolOperationHelpers.Convert(response, OperationStatus.FromResponse, ClientDiagnostics, "StandardClient.Delete");
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="DeleteAsync(WaitUntil,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Operation<BinaryData>> DeleteAsync(WaitUntil waitUntil, string name, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "StandardClient.Delete", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Delete(WaitUntil,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual Operation<BinaryData> Delete(WaitUntil waitUntil, string name, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            ...
            {
                using HttpMessage message = CreateDeleteRequest(name, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "StandardClient.Delete", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
