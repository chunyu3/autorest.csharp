...
namespace _Specs_.Azure.Core.Lro.Standard.Samples
{
    public class Samples_StandardClient
    {
        ...
        public void Example_CreateOrReplace_AllParameters()
        {
            ...
            var operation = client.CreateOrReplace(WaitUntil.Completed, "<name>", RequestContent.Create(data), new RequestContext());
        ...
        public async Task Example_CreateOrReplace_AllParameters_Async()
        {
            ...
            var operation = await client.CreateOrReplaceAsync(WaitUntil.Completed, "<name>", RequestContent.Create(data), new RequestContext());
        ...
        public void Example_Delete()
        {
            ...
            var operation = client.Delete(WaitUntil.Completed, "<name>", new RequestContext());
        ...
        public async Task Example_Delete_Async()
        {
            ...
            var operation = await client.DeleteAsync(WaitUntil.Completed, "<name>", new RequestContext());
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Delete_Convenience_Async()
        {
            var client = new StandardClient();
